/*
================================================================================
File: src/main/java/com/dta/clientapp/services/AuthService.java
Description: Handles client authentication against the server.
================================================================================
*/
...
public class AuthService {
    ...
    public Optional<String> login(String email, String password) throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(API_BASE_URL + "/client/login")) // Points to client login endpoint
